...
IL2CPP_EXTERN_C String_t* _stringLiteral395FFA32FFAAF6D8A772F93E9C85968A573C51AA;
...
struct TestFeatures_tC9C00AD8441975DD5C37D7B38F07AB2ADDD7B048  : public MonoBehaviour_t532A11E69716D348D8AA7F854AFCBFCB8AD17F71
{
	...
	// UnityEngine.Camera TestFeatures::thisCamera
	Camera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184* ___thisCamera_7;
	// UnityEngine.GameObject TestFeatures::testPrefab
	GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* ___testPrefab_8;
	// System.Boolean TestFeatures::instantiated
	bool ___instantiated_9;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MainMenuScript_Awake_mDAD26BEC85287E88983DC823CA29D55BD68097F6 (MainMenuScript_tE48C74D2C0B2E001BA00CACB8CF59B50BA024B4C* __this, const RuntimeMethod* method) 
{
	...
	if (!s_Il2CppMethodInitialized)
	{
		...
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&_stringLiteral395FFA32FFAAF6D8A772F93E9C85968A573C51AA);
		s_Il2CppMethodInitialized = true;
	}
	GPSCoordinateU5BU5D_t8D20723DF2CD9A7F5456DDFE45D8B9F5FC13C634* V_0 = NULL;
	int32_t V_1 = 0;
	GPSCoordinate_tFD055BA33C64D753DC4264715E7297BF4F35EFD0* V_2 = NULL;
	...
	RuntimeObject* V_5 = NULL;
	{
		...
		NullCheck(L_2);
		VirtualActionInvoker1< String_t* >::Invoke(75 /* System.Void UnityEngine.UI.Text::set_text(System.String) */, L_2, _stringLiteral395FFA32FFAAF6D8A772F93E9C85968A573C51AA);
		...
		GPSCoordinateU5BU5D_t8D20723DF2CD9A7F5456DDFE45D8B9F5FC13C634* L_4;
		L_4 = MainMenuScript_InitializeHotspots_m658F64AB023BB8D8CE19D8C915AD71B554AFE9C6(__this, NULL);
		// Debug.Log(hotspots[0]);
		GPSCoordinateU5BU5D_t8D20723DF2CD9A7F5456DDFE45D8B9F5FC13C634* L_5 = L_4;
		NullCheck(L_5);
		int32_t L_6 = 0;
		GPSCoordinate_tFD055BA33C64D753DC4264715E7297BF4F35EFD0* L_7 = (L_5)->GetAt(static_cast<il2cpp_array_size_t>(L_6));
		il2cpp_codegen_runtime_class_init_inline(Debug_t8394C7EEAECA3689C2C9B9DE9C7166D73596276F_il2cpp_TypeInfo_var);
...
IL_0044:
	{
		// foreach(GPSCoordinate hotspot in hotspots)
		GPSCoordinateU5BU5D_t8D20723DF2CD9A7F5456DDFE45D8B9F5FC13C634* L_8 = V_0;
		int32_t L_9 = V_1;
		NullCheck(L_8);
		int32_t L_10 = L_9;
		GPSCoordinate_tFD055BA33C64D753DC4264715E7297BF4F35EFD0* L_11 = (L_8)->GetAt(static_cast<il2cpp_array_size_t>(L_10));
		V_2 = L_11;
		// lokescions.Add(new Vector2(hotspot.Gps_position.x, hotspot.Gps_position.y), hotspot.Name);
		Hashtable_tEFC3B6496E6747787D8BB761B51F2AE3A8CFFE2D* L_12 = __this->___lokescions_9;
		GPSCoordinate_tFD055BA33C64D753DC4264715E7297BF4F35EFD0* L_13 = V_2;
		NullCheck(L_13);
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7 L_14;
		L_14 = GPSCoordinate_get_Gps_position_m60FA210D9F56ABE4EDCC42DC9F8CFA2731A5AF2A_inline(L_13, NULL);
		float L_15 = L_14.___x_0;
		GPSCoordinate_tFD055BA33C64D753DC4264715E7297BF4F35EFD0* L_16 = V_2;
		NullCheck(L_16);
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7 L_17;
		L_17 = GPSCoordinate_get_Gps_position_m60FA210D9F56ABE4EDCC42DC9F8CFA2731A5AF2A_inline(L_16, NULL);
		...
		GPSCoordinate_tFD055BA33C64D753DC4264715E7297BF4F35EFD0* L_22 = V_2;
		NullCheck(L_22);
		String_t* L_23;
		L_23 = GPSCoordinate_get_Name_m3A25563B3BD903C9857B3B5A8F55FB6F8B2E7760_inline(L_22, NULL);
		NullCheck(L_12);
		VirtualActionInvoker2< RuntimeObject*, RuntimeObject* >::Invoke(15 /* System.Void System.Collections.Hashtable::Add(System.Object,System.Object) */, L_12, L_21, L_23);
		int32_t L_24 = V_1;
...
IL_007d:
	{
		// foreach(GPSCoordinate hotspot in hotspots)
		int32_t L_25 = V_1;
		GPSCoordinateU5BU5D_t8D20723DF2CD9A7F5456DDFE45D8B9F5FC13C634* L_26 = V_0;
		NullCheck(L_26);
	...
	}
	{
		...
		Rect__ctor_m18C3033D135097BEE424AAA68D91C706D2647F23((&L_27), (40.5f), (14.5f), (1.0f), (1.0f), /*hidden argument*/NULL);
		QuadTree_t9A0D214A6C2B01927D761A4D73B83A6C8E8B6F3F* L_28 = (QuadTree_t9A0D214A6C2B01927D761A4D73B83A6C8E8B6F3F*)il2cpp_codegen_object_new(QuadTree_t9A0D214A6C2B01927D761A4D73B83A6C8E8B6F3F_il2cpp_TypeInfo_var);
		NullCheck(L_28);
		QuadTree__ctor_mF9467EBA71AC853F22630931679A45757629ECCE(L_28, L_27, 2, NULL);
		__this->___locations_7 = L_28;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___locations_7), (void*)L_28);
		// foreach (Vector2 point in lokescions.Keys)
		Hashtable_tEFC3B6496E6747787D8BB761B51F2AE3A8CFFE2D* L_29 = __this->___lokescions_9;
		NullCheck(L_29);
		RuntimeObject* L_30;
		L_30 = VirtualFuncInvoker0< RuntimeObject* >::Invoke(25 /* System.Collections.ICollection System.Collections.Hashtable::get_Keys() */, L_29);
		NullCheck(L_30);
		RuntimeObject* L_31;
			...
			{// begin finally (depth: 1)
				{
					...
					V_5 = ((RuntimeObject*)IsInst((RuntimeObject*)L_32, IDisposable_t030E0496B4E0E4E4F086825007979AF51F7248C5_il2cpp_TypeInfo_var));
...
IL_00bb_1:
			{
				...
				V_4 = ((*(Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7*)((Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7*)(Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7*)UnBox(L_36, Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7_il2cpp_TypeInfo_var))));
				// locations.Insert(point);
				QuadTree_t9A0D214A6C2B01927D761A4D73B83A6C8E8B6F3F* L_37 = __this->___locations_7;
				Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7 L_38 = V_4;
				NullCheck(L_37);
				QuadTree_Insert_mDDB4B5A9B63C8F34EE454094B735E4CD4228AB3B(L_37, L_38, NULL);
			}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MainMenuScript_Start_mC1D05E15D183A59D0A7AB8AB22E0AA1BBFD1F78F (MainMenuScript_tE48C74D2C0B2E001BA00CACB8CF59B50BA024B4C* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		LocationService_tF2F2720FE2C07562EBFD128889F9A99F4B41B1B2* L_0 = __this->___locServ_5;
		NullCheck(L_0);
		int32_t L_1;
	...
	}
	{
		...
		RuntimeObject* L_2;
		L_2 = MainMenuScript_checkLocation_mB1E3C42343BE130B330F6D26B71CD0235691A534(__this, NULL);
		...
		String_t* L_7;
		L_7 = String_Concat_m9E3155FB84015C823606188F53B47CB44C444991(L_6, _stringLiteralAC0C4017001E73CC7120DA5781F8FEF18B16BD9A, NULL);
		NullCheck(L_5);
...
IL_0041:
	{
		...
		Text_tD60B2346DAA6666BF0D822FF607F0B220C2B9E62* L_8 = __this->___menuText_4;
		...
		String_t* L_11;
		L_11 = String_Concat_m9E3155FB84015C823606188F53B47CB44C444991(L_10, _stringLiteral0FE4DCD2F314FA13CCE624D52CAFCE0C00848861, NULL);
		NullCheck(L_9);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR GPSCoordinateU5BU5D_t8D20723DF2CD9A7F5456DDFE45D8B9F5FC13C634* MainMenuScript_InitializeHotspots_m658F64AB023BB8D8CE19D8C915AD71B554AFE9C6 (MainMenuScript_tE48C74D2C0B2E001BA00CACB8CF59B50BA024B4C* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		JsonHotspots_t2C129439CA49061046C150DAD35DDBC61CC98BCD* L_6;
		L_6 = JsonUtility_FromJson_TisJsonHotspots_t2C129439CA49061046C150DAD35DDBC61CC98BCD_m7E6B90228350562D99DFF55AB8F03EF8A315EB13(L_5, JsonUtility_FromJson_TisJsonHotspots_t2C129439CA49061046C150DAD35DDBC61CC98BCD_m7E6B90228350562D99DFF55AB8F03EF8A315EB13_RuntimeMethod_var);
		// return jsonHotspots.hotspots;
		NullCheck(L_6);
		GPSCoordinateU5BU5D_t8D20723DF2CD9A7F5456DDFE45D8B9F5FC13C634* L_7 = L_6->___hotspots_0;
		return L_7;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TestFeatures_Update_mDE565D73A66B424AE1C504BBE28132A319FC4297 (TestFeatures_tC9C00AD8441975DD5C37D7B38F07AB2ADDD7B048* __this, const RuntimeMethod* method) 
{
	...
	{
		bool L_1 = __this->___instantiated_9;
		if (L_1)
		{
			goto IL_0069;
		}
	}
	{
		...
		Camera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184* L_2 = __this->___thisCamera_7;
		NullCheck(L_2);
		...
		V_0 = L_6;
		// Instantiate(testPrefab, spawnPosition, thisCamera.transform.rotation);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_7 = __this->___testPrefab_8;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_8 = V_0;
		Camera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184* L_9 = __this->___thisCamera_7;
		NullCheck(L_9);
		...
		// instantiated = true;
		__this->___instantiated_9 = (bool)1;
		// debugText.color = Color.red;
		TextMeshProUGUI_t101091AF4B578BB534C92E9D1EEAF0611636D957* L_13 = __this->___debugText_10;
